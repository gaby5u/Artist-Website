...
arrowIcons.forEach (icon => {
  icon.addEventListener("click", () => {
    ...
    carousel.scrollLeft +=icon.id == "left-arrow" ? -firstYearWidth : firstYearWidth;
...
const infoCronologySlider = {
  ...
  An1974: [1974,"Expoziție itinerantă organizată de The Whitney Museum of American Art."],
  An1986: [1986,"Retrospectivă la Muzeul Whitney de Artă Americană."],
  An1996: [1996,"Expoziție itinerantă organizată de Institutul Munson-Williams Proctor."],
  An2000: [2000,"Alex Katz la Carnegie Museum of Art, Pittsburgh."],
  An2003: [2003,"Alex Katz: Decupaje la Deichtorhallen Hamburg, Hamburg, Germania."],
  An2006: [2006,"Alex Katz o pictează pe Ada 1957–2005 la The Jewish Museum, New York."],
  An2009: [2009,"Expoziție An American Way Of Seeing organizată de Muzeul de Artă Sara Hildén."],
