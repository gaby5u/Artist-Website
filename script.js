...
const changeSlidesAutomatic = () => {
  const bgImages = [
    "url('img/background-img-carousel/background-img-carousel-1.png')",
    "url('img/background-img-carousel/background-img-carousel-2.png')",
    "url('img/background-img-carousel/background-img-carousel-3.png')",
    "url('img/background-img-carousel/background-img-carousel-4.png')",
    "url('img/background-img-carousel/background-img-carousel-5.png')",
  ];
